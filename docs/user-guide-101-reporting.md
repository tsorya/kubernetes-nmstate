...
We support configuration through configmap created from file:
    ...
    1. Create file `nmstate.yaml` (default name)
        ----- content --------
        node_network_state_refresh_interval: "60"
   ...
   The Refresh interval will be changed to 60 seconds and interface filtering will be changed to "vnet*".
...
adjusted via `node_network_state_refresh_interval` variable in configuration file
